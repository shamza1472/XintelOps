...
- **Niche bias + live momentum:** Tier 1/2 identity matters, but Live Momentum ≥ 8 can override static region preference
- Score every signal with `live_momentum` (1–10); set `best_immediate_post`, `best_strategic_lead`, `best_archive_signal`
